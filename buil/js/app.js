...
function crearGaleria() {
    ...
    for (let t = 1; t <= 12; t++) {
        ...
        n.innerHTML = `\n < img loading = "lazy" width = "1000" height = "100" src = "buil/img/thumb/${t}.jpg" alt = "imagen galeria" > \n `,
            n.onclick = function () {
                mostrarImagen(t)
            },
            e.appendChild(n)
...
function mostrarImagen(e) {
    ...
    t.innerHTML = `\n < img src = "buil/img/grande/${e}.jpg" alt = "imagen galeria" > \n `;
